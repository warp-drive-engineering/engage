...
export async function validateGithubUrl(config) {
    ...
    const errorMsg = `create-project requires a githubUrl of the form "${chalk.grey(`git@github.com:<githubAccount>/<repoName>.git`)}" to be specified for the new project. Received ${url}`;
