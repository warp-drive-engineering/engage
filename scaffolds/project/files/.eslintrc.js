...
module.exports = {
  ...
  rules: {
    // general rules to activate when we can
    eqeqeq: "off", // 3281 errors as of 11/30/21 NOTE: this rule is strangely not in the recommended set
    "no-eq-null": "off", // 102 errors
    ...
    "prefer-rest-params": "off", // 435 errors
    "no-shadow": "off", // 60 errors
    "no-loop-func": "off",

    // these are a nice proxy measurement of where there is complexity to pay down
    // but do not need to be enforced as of yet.
    // we should dial them in and turn them on over time to prevent absurdly long functions etc.
    "max-params": ["off", 4],
    "max-depth": ["off", { max: 4 }],
    "max-statements": ["off", { max: 20 }],
    "max-lines-per-function": ["off", { max: 60 }],
    ...
    // rules that are likely good and we should consider
    "no-lonely-if": "off",
    "no-labels": "off",
    ...
    "no-useless-assign/no-useless-assign": "error", // 72 as of 11/30/2021
    ...
    // ember rules to re-activate when we can
    "ember/no-classic-classes": "off",
    "ember/no-get": "off", // 6704 as of 11/4/21
    "ember/no-jquery": "off", // 1463 as of 11/30/21
    "ember/require-return-from-computed": "off", //72 as of 10/16/21
    "ember/no-actions-hash": "off",
    "ember/avoid-leaking-state-in-ember-objects": "off", // 196 as of 10/16/21
    "ember/no-mixins": "off",
    "ember/no-new-mixins": "error",
    "ember/no-controller-access-in-routes": "off",
    "ember/closure-actions": "off", // 852 as of 10/16/21
    "ember/no-component-lifecycle-hooks": "off",
    "ember/no-observers": "off", // 60 as of 10/16/21
    "ember/require-tagless-components": "off", // 635 as of 10/16/21
    "ember/no-classic-components": "off",
    "ember/no-side-effects": "off", // 43 as of 10/16/21
    ...
    "unicorn/prefer-add-event-listener": "off", // we want this but cant until we arent using jquery
    ...
    "unicorn/no-unsafe-regex": "off", // 19 errors, mostly on currency formatting: we should be using intl and toLocaleString to format instead
  ...
  overrides: [
    // Javascript files in strict-mode
    {
      files: [
        "frontend/addons/core/**/*.js",
        "frontend/engines/labor-employee-engine/**/*.js",
        "frontend/apps/labor-employee-app/**/*.js",
      ],
      rules: {
        eqeqeq: "error",
        "no-eq-null": "error",
    ...
    // node files
    {
      files: [
        ...
        "frontend/*/*/testem.js",
        "frontend/*/*/blueprints/*/index.js",
        "frontend/*/*/config/**/*.js",
        "frontend/*/*/tests/dummy/config/**/*.js",
        "frontend/*/*/index.js",
        "frontend/*/*/lib/*/index.js",
        "frontend/*/*/server/**/*.js",
        "frontend/apps/craftable-web/migrations/**/*.js",
      ],
      parserOptions: {
        sourceType: "script",
      },
